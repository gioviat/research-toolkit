...
- Inflated vocabulary where a plain word means the same thing: delve, leverage, robust, multifaceted, testament, tapestry, comprehensive (as a filler adjective), utilize (use "use")
